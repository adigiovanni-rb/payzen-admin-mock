...
export declare class CompanyRequestBodyModel {
    ...
    constructor(registration: RegistrationRequestModel, details: DetailsRequestModel, trading: TradingRequestModel, customization: CustomizationRequestModel, contacts: ContactsModel);
}
